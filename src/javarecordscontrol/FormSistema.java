...
public class FormSistema extends javax.swing.JFrame {
    // Declarar estruturas
    String mensagem = "";
    Pilha<Recorde> pilhaPrincipal = new Pilha<Recorde>(10);
    Pilha<Recorde> pilhaAuxiliar = new Pilha<Recorde>(10);
    private void exibirPilhaPrincipal(){
        listPilha.setText(pilhaPrincipal.toString());
    }
    private void exibirPilhaAuxiliar(){
        listAux.setText(pilhaAuxiliar.toString());
    }
    public FormSistema() {
        initComponents();
        if(!pilhaPrincipal.isEmpty()){
            exibirPilhaPrincipal();
        }
    }
    ...
    private void initComponents() {
        ...
        txtTempo.setMinimumSize(new java.awt.Dimension(64, 39));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        novoRecorde.setData(LocalDate.parse(txtData.getText(), DateTimeFormatter.ofPattern("dd/MM/yyyy")));
        novoRecorde.setTempo(parseDouble(txtTempo.getText()));

        try{
            if(pilhaPrincipal.push(novoRecorde)){
                mensagem = "Recorde adicionado com sucesso!";
                JOptionPane.showMessageDialog(null, mensagem);
            }else{
                mensagem = ("O novo recorde não é melhor que o anterior!");
                JOptionPane.showMessageDialog(null, mensagem);
            }
        }catch(Exception e){
            mensagem = ("Não foi possível adicionar o recorde: " + e + "!");
            JOptionPane.showMessageDialog(null, mensagem);
        }
        exibirPilhaPrincipal();
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        try{
            if (!pilhaPrincipal.isEmpty() && !pilhaAuxiliar.isEmpty()) {
                if (pilhaPrincipal.peek().getTempo() < pilhaAuxiliar.peek().getTempo()){
                    pilhaAuxiliar.push(pilhaPrincipal.pop());
                }else{
                mensagem = ("O recorde da pilha auxiliar é melhor do que o que está sendo desempilhado");
                JOptionPane.showMessageDialog(null, mensagem);
                } 
            }else if (!pilhaPrincipal.isEmpty()) {
                pilhaAuxiliar.push(pilhaPrincipal.pop());
            }
        }catch(Exception e){
            mensagem = ("Não foi possível desempilhar: " + e  + "!");
            JOptionPane.showMessageDialog(null, mensagem);
        }
        exibirPilhaAuxiliar();
        exibirPilhaPrincipal();
    ...
    private void btnLimparActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimparActionPerformed
        ...
        try{
            if(!pilhaAuxiliar.isEmpty() || !pilhaPrincipal.isEmpty()){
                pilhaAuxiliar.clear();
            pilhaPrincipal.clear();
            exibirPilhaAuxiliar();
            exibirPilhaPrincipal();
            mensagem = ("Limpeza de dados efetuada com sucesso!");
            JOptionPane.showMessageDialog(null, mensagem);
            }else{
                mensagem = ("Não há dados para serem limpos!");
                JOptionPane.showMessageDialog(null, mensagem);
            }
        }catch(Exception e){
            mensagem = ("Não foi possível limpar as pilhas: " + e + "!");
            JOptionPane.showMessageDialog(null, mensagem);
        }
